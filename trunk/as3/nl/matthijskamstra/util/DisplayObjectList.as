...
package nl.matthijskamstra.util {
	...
	public class DisplayObjectList {
		...
		// Constants:
		public static var LINKAGE_ID : String = "nl.matthijskamstra.util.DisplayObjectList";
		// vars
		/**
		* Constructor
		* @usage   	import nl.matthijskamstra.util.DisplayObjectList; // import
		*			var __DisplayObjectList__ : nl.matthijskamstra.util.DisplayObjectList = new nl.matthijskamstra.util.DisplayObjectList ();
		*/
