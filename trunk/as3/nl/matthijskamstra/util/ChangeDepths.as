...
package nl.matthijskamstra.util {
	...
	import nl.consumentveiligheid.splittherisk.util.PixelGrid;
	...
	public class ChangeDepths  {
		...
		// Constants:
		public static var CLASS_REF = nl.matthijskamstra.util.ChangeDepths;
		public static var CLASS_NAME : String = "ChangeDepths";
		public static var LINKAGE_ID : String = "nl.matthijskamstra.util.ChangeDepths";
		// vars
		...
		* Constructor
		* 
		* @usage   	import nl.matthijskamstra.util.ChangeDepths; // import
		*			var __ChangeDepths:nl.matthijskamstra.util.ChangeDepths = new nl.matthijskamstra.util.ChangeDepths ( this );
