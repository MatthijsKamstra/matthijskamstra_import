...
package nl.matthijskamstra.util {
	...
	public class Trace {
		...
		// Constants:
		public static var LINKAGE_ID : String = "nl.matthijskamstra.util.TraceObject";
		// vars
		
		/**
		* Constructor
		* 
		* @usage   	import nl.matthijskamstra.util.TraceObject; // import
		*			var __TraceObject__ : nl.matthijskamstra.util.TraceObject = new nl.matthijskamstra.util.TraceObject ();
		*/
