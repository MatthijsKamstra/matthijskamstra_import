...
package nl.matthijskamstra.myfilters { 
	...
	public class Glow {
		...
		// vars
		var defaultObj:Object = { color: 0x000000, alpha: 50, blurX: 15, blurY: 15, strength: 20, quality: "High", inner: false, knockout: false }
		...
		*/
		public function Glow( $target_mc:Object, $obj:Object = null )  {
		...
		* @param	$obj			extra values for filters
		*/
		static public function initGlow ($target_mc:Object, $obj:Object = null) : void {
			var __initGlow:Glow = new Glow ( $target_mc, $obj );
		}
