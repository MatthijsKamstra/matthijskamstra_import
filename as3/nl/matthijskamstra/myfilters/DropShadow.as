...
* 
*/
package nl.matthijskamstra.myfilters { 
	...
	public class DropShadow {
		...
		*/
		public function DropShadow( $target_mc:Object, $obj:Object = null )  {
			trace( "DropShadow.DropShadow > $target_mc : " + $target_mc + ", $obj : " + $obj );
			if ( $target_mc == null ) { return; }
			if ($obj == null) {
				$obj = { distance:5, angleInDegrees:45, color:0x000000, alpha:1, blurX:10, blurY:10, strength:40, quality:3, inner:false, knockout:false, hideObject:false };
			}
		...
		* @param	$obj			extra values for filters
		*/
		static public function initDropShadow ($target_mc:Object, $obj:Object = null) : void {
			var __initDropShadow:DropShadow = new DropShadow ( $target_mc, $obj );
		}
