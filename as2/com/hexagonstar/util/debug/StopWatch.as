...
class com.hexagonstar.util.debug.StopWatch 
{
	...
	public function toString():String
	{
		...
		var i:Number = 0;
		for (i = 0; i < _startTimeKeys.length; i++)
		{
			var s1:Number = _startTimeKeys[i];
			var s2:Number = _stopTimeKeys[i];
			s += "\n * started ["
	...
	public function get timeInMilliSeconds():Number
	{
		...
		var r:Number = 0;
		for (var i:Number = 0; i < _startTimeKeys.length; i++)
		{
	 ...
	 * @private
	 */
	private function format(v:Number):String
	{
		var s:String = "";
		var l:Number = v.toString().length;
		for (var i:Number = 0; i < (5 - l); i++)
		{
			s += "0";
		}
		return s + v;
